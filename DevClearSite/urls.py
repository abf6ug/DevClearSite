...
urlpatterns = patterns('',
                       ...
                       url(r'^home/inbox/(?P<profile_type>[\w|\W]+)/(?P<profile_name>[\w|\W]+)/(?P<sender_id>\d+)$', 'DevClear.views.inbox', name='inbox'),
                    ...
                    #url(r'^profile/(?P<org_name>[\w|\W]+)/feed/$', 'DevClear.views.profile_feed', name='view_profile_feed'),
                       ...
                       url(r'^project/(?P<proj_name>[\w|\W]+)/$', 'DevClear.views.view_project_profile', name='view_project_profile'),
